...
const AddStation = ({ showModal, setShowModal, onStationAdded, onError, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:3000/stations/create-station", {
        method: "POST",
        body: formDataToSend,
      });
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.message || "Erreur lors de la création de la station");
      }
      ...
      setShowModal(false);
      onSuccess("Station créée avec succès !");
